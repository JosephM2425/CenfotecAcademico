...
function wrapperWithUser(usuario: AuthUser | null) {
  return function Wrapper({ children }: { children: ReactNode }) {
    return (
      <UsuarioContext.Provider value={{ usuario, isLoaded: true }}>{children}</UsuarioContext.Provider>
    )
  }
}
...
describe('useRole', () => {
  ...
  it('throws when used outside a UsuarioProvider', () => {
    expect(() => renderHook(() => useRole())).toThrow(/UsuarioProvider/)
  })
})
