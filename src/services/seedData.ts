...
export const usuariosSeed: Usuario[] = [
  { id: 1, nombre: 'Admin Sistema', email: 'admin@universidad.ac.cr', rol: 'Administrador', estado: 'Activo', fechaRegistro: '2023-01-15' },
  { id: 2, nombre: 'Dr. Roberto García', email: 'rgarcia@universidad.ac.cr', rol: 'Docente', estado: 'Activo', fechaRegistro: '2023-02-20' },
  { id: 3, nombre: 'María Fernández', email: 'mfernandez@universidad.ac.cr', rol: 'Estudiante', estado: 'Activo', fechaRegistro: '2023-03-10' },
  { id: 4, nombre: 'Dr. Carlos Ramírez', email: 'cramirez@universidad.ac.cr', rol: 'Investigador', estado: 'Activo', fechaRegistro: '2023-01-25' },
  { id: 5, nombre: 'Ana Mora López', email: 'amora@universidad.ac.cr', rol: 'Docente', estado: 'Inactivo', fechaRegistro: '2023-04-05' },
  { id: 6, nombre: 'José Rodríguez', email: 'jrodriguez@universidad.ac.cr', rol: 'Estudiante', estado: 'Activo', fechaRegistro: '2023-05-12' },
  { id: 7, nombre: 'Laura Jiménez', email: 'ljimenez@universidad.ac.cr', rol: 'Investigador', estado: 'Activo', fechaRegistro: '2023-06-18' },
  { id: 8, nombre: 'Pedro Sánchez', email: 'psanchez@universidad.ac.cr', rol: 'Estudiante', estado: 'Activo', fechaRegistro: '2023-07-22' },
]

export const tiposProduccionSeed: CatalogItem[] = [
  { id: 1, nombre: 'Tesis', descripcion: 'Trabajo de investigación para optar por un grado académico' },
  { id: 2, nombre: 'Artículo', descripcion: 'Publicación en revista científica o académica' },
  { id: 3, nombre: 'Proyecto de Graduación', descripcion: 'Proyecto aplicado como requisito de graduación' },
  { id: 4, nombre: 'Ponencia', descripcion: 'Presentación en congreso o conferencia académica' },
  { id: 5, nombre: 'Informe Técnico', descripcion: 'Documento técnico resultado de investigación' },
]

export const categoriasSeed: CatalogItem[] = [
  { id: 1, nombre: 'Pregrado', descripcion: 'Producción de nivel licenciatura o bachillerato' },
  { id: 2, nombre: 'Posgrado', descripcion: 'Producción de nivel maestría o doctorado' },
  { id: 3, nombre: 'Investigación', descripcion: 'Producción resultado de proyectos de investigación' },
  { id: 4, nombre: 'Extensión', descripcion: 'Producción vinculada a proyectos de extensión universitaria' },
]

export const areasSeed: CatalogItem[] = [
  { id: 1, nombre: 'Ingeniería de Software', descripcion: 'Desarrollo, diseño y gestión de sistemas de software' },
  { id: 2, nombre: 'Inteligencia Artificial', descripcion: 'Machine learning, NLP, visión por computadora' },
  { id: 3, nombre: 'Ciberseguridad', descripcion: 'Seguridad informática y protección de datos' },
  { id: 4, nombre: 'Ciencia de Datos', descripcion: 'Análisis, procesamiento y visualización de datos' },
  { id: 5, nombre: 'Tecnología Educativa', descripcion: 'Aplicación de tecnología en procesos educativos' },
  { id: 6, nombre: 'Internet de las Cosas', descripcion: 'Dispositivos conectados y sistemas embebidos' },
  { id: 7, nombre: 'Tecnologías Emergentes', descripcion: 'Blockchain, realidad aumentada, computación cuántica' },
]

export const tecnologiasSeed: CatalogItem[] = [
  { id: 1, nombre: 'Python', descripcion: 'Lenguaje de programación de propósito general' },
  { id: 2, nombre: 'Java', descripcion: 'Lenguaje de programación orientado a objetos' },
  ...
  { id: 5, nombre: 'Node.js', descripcion: 'Entorno de ejecución JavaScript del lado del servidor' },
  { id: 6, nombre: 'TensorFlow', descripcion: 'Framework de aprendizaje automático' },
  ...
  { id: 10, nombre: 'PostgreSQL', descripcion: 'Sistema de gestión de bases de datos relacional' },
]

export const tiposInvestigacionSeed: CatalogItem[] = [
  { id: 1, nombre: 'Básica', descripcion: 'Investigación teórica que busca ampliar el conocimiento' },
  { id: 2, nombre: 'Aplicada', descripcion: 'Investigación orientada a resolver problemas prácticos' },
  { id: 3, nombre: 'Exploratoria', descripcion: 'Primer acercamiento a un tema poco estudiado' },
  { id: 4, nombre: 'Descriptiva', descripcion: 'Describe características y propiedades del fenómeno' },
  { id: 5, nombre: 'Correlacional', descripcion: 'Evalúa la relación entre dos o más variables' },
]

export const carrerasSeed: CatalogItem[] = [
  { id: 1, nombre: 'Ingeniería en Sistemas', descripcion: 'Formación en desarrollo y gestión de sistemas informáticos' },
  { id: 2, nombre: 'Ingeniería en Computación', descripcion: 'Formación en hardware, software y redes' },
  { id: 3, nombre: 'Administración de Empresas', descripcion: 'Formación en gestión y dirección empresarial' },
  { id: 4, nombre: 'Ingeniería Industrial', descripcion: 'Optimización de procesos productivos y de servicios' },
  { id: 5, nombre: 'Diseño Gráfico', descripcion: 'Comunicación visual y diseño de interfaces' },
]

export const lineasSeed: CatalogItem[] = [
  { id: 1, nombre: 'Desarrollo de Software', descripcion: 'Metodologías, herramientas y prácticas de ingeniería de software' },
  { id: 2, nombre: 'Inteligencia Artificial', descripcion: 'Investigación en ML, deep learning y sistemas inteligentes' },
  { id: 3, nombre: 'Seguridad Informática', descripcion: 'Protección de sistemas, redes y datos' },
  { id: 4, nombre: 'Ciencia de Datos', descripcion: 'Big data, analítica y visualización' },
  { id: 5, nombre: 'Tecnología Educativa', descripcion: 'Innovación tecnológica en educación' },
  { id: 6, nombre: 'IoT y Sistemas Embebidos', descripcion: 'Dispositivos inteligentes y sistemas conectados' },
  { id: 7, nombre: 'Tecnologías Emergentes', descripcion: 'Blockchain, AR/VR, computación cuántica' },
  { id: 8, nombre: 'Innovación Educativa', descripcion: 'Nuevos modelos y estrategias pedagógicas' },
]
